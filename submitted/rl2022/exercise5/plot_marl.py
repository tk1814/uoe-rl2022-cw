...
SEEDS = 5
SAVEFIG = "marl.pdf" # give string to save file with generated plots under given name
...
if __name__ == "__main__":
    ...
    visualise_both_q_convergence(iql_total_eval_q_tables, jal_total_eval_q_tables, env, savefig=SAVEFIG)
